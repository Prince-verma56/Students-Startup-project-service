...
const Heading = ({ children }: { children: React.ReactNode }) => (
  <div data-heading style={{ fontFamily: FN, fontWeight: 900, fontSize: "clamp(1.65rem,2.7vw,2.9rem)", color: INK, lineHeight: 1.05, letterSpacing: "-.03em" }}>{children}</div>
)
const Stars = () => (
...
// ═══════════════════════════════════════════════════════════════════
// SKILL RINGS — Apple Activity style
// ═══════════════════════════════════════════════════════════════════
function SkillRings() {
  const rings = [
    ...
    <div data-skill-ring style={{ display: "flex", alignItems: "center", gap: 20 }}>
      <div style={{ position: "relative", width: 108, height: 108, flexShrink: 0 }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
          ...
          <span style={{ fontFamily: FN, fontSize: 9, fontWeight: 900, color: INK, lineHeight: 1 }}>Tech</span>
        </div>
      </div>
...
function PhaseProgressBar({ value, color = "linear-gradient(90deg,#818cf8,#6366f1)", idx = 0 }: {
  ...
  return (
    <div style={{ height: 5, borderRadius: 3, background: "rgba(99,102,241,.09)", overflow: "hidden" }}>
      <div data-prog-bar data-target={value} data-delay={idx * 0.08}
...
const StatChip = memo(function StatChip({ v, sx, label, Icon, tint, idx }: {
  ...
  return (
    <div ref={wrapRef} data-stat-chip style={{ ...gCard(16), padding: "13px 16px", display: "flex", alignItems: "center", gap: 13 }}>
      ...
      <div style={{ flex: 1 }}>
        <span ref={valRef} style={{ display: "block", fontFamily: FN, fontWeight: 900, fontSize: 24, color: INK, lineHeight: 1, letterSpacing: "-.025em" }}>{v}{sx}</span>
  ...
  return (
    <div data-panel-inner style={{ display: "flex", flexDirection: "column", gap: 8, height: "100%", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
        {TECH_LIST.map(t => <TechBadge key={t.label} {...t} />)}
      </div>
      ...
      <div style={{ ...gSub(13), padding: "10px 14px", display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: FR, fontSize: 10, fontWeight: 700, color: INK }}>Currently available</div>
...
function P1R() {
  return (
    <div data-panel-inner style={{ display: "flex", flexDirection: "column", gap: 9, height: "100%", overflow: "hidden" }}>
      ...
      <LiquidGlassCard className="rounded-2xl border-white/10 bg-white/10" glassSize="sm">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          ...
          <div>
            <p style={{ fontFamily: FR, fontWeight: 700, fontSize: 10.5, color: INK }}>Aryan S. <span style={{ color: C.muted, fontWeight: 400 }}>· Final Year CSE, SPPU</span></p>
            <Stars />
          </div>
        </div>
      </LiquidGlassCard>
        ...
        <div key={p.name} style={{ ...gCard(15), padding: "12px 15px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 7 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontFamily: FR, fontSize: 11, fontWeight: 700, color: INK }}>{p.name}</span>
            </div>
  ...
  return (
    <div data-panel-inner style={{ display: "flex", flexDirection: "column", gap: 9, height: "100%", overflow: "hidden" }}>
      ...
      <div style={{ ...gTint("#f87171", 13), padding: "10px 14px", display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div>
          <div style={{ fontFamily: FR, fontSize: 10, fontWeight: 700, color: INK }}>2 projects active right now</div>
      ...
      <LiquidGlassCard className="rounded-2xl border-white/10 bg-white/10" glassSize="sm">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
          ...
          <div>
            <p style={{ fontFamily: FR, fontWeight: 700, fontSize: 10.5, color: INK }}>Priya M. <span style={{ color: C.muted, fontWeight: 400 }}>· 3rd Year IT, VIT</span></p>
            <Stars />
          </div>
        </div>
      </LiquidGlassCard>
            ...
            <div key={g.l}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 11 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontFamily: FR, fontSize: 10, fontWeight: 700, color: INK }}>{g.l}</div>
  ...
  return (
    <div data-panel-inner style={{ display: "flex", flexDirection: "column", gap: 9, height: "100%", overflow: "hidden" }}>
      {[
        ...
        { q: "Saved my semester. 2 days for a full-stack app — he even called to walk me through the code before my demo.", name: "Priya M.", role: "3rd Year IT, VIT", av: "P", g: "linear-gradient(135deg,#34d399,#059669)" },
      ].map(t => (
        <LiquidGlassCard key={t.name} className="rounded-2xl border-white/10 bg-white/10" glassSize="sm">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            ...
            <div>
              <p style={{ fontFamily: FR, fontWeight: 700, fontSize: 10.5, color: INK }}>{t.name} <span style={{ color: C.muted, fontWeight: 400 }}>· {t.role}</span></p>
              <Stars />
            </div>
          </div>
        </LiquidGlassCard>
        ...
        {tl.map((step, i) => (
          <div key={step.day} style={{ display: "flex", gap: 11, alignItems: "flex-start" }}>
            ...
            <div style={{ paddingBottom: i < tl.length - 1 ? 4 : 0 }}>
              <div style={{ fontFamily: FR, fontSize: 10, fontWeight: 700, color: INK }}>{step.day} · {step.t}</div>
  ...
  return (
    <div data-panel-inner style={{ display: "flex", flexDirection: "column", gap: 9, height: "100%", overflow: "hidden" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
          {[
            ...
            <div key={m.l} style={{ ...gTint(m.c, 12), padding: "10px 12px" }}>
              ...
              <PhaseProgressBar value={m.pct} color={`linear-gradient(90deg,${m.c}88,${m.c})`} idx={i} />
            </div>
          ))}
        </div>
      </div>
      <div style={{ ...gSub(13), padding: "10px 14px", display: "flex", alignItems: "center", gap: 10 }}>
        <div style={{ width: 9, height: 9, borderRadius: "50%", background: "#f87171", boxShadow: "0 0 0 3px rgba(248,113,113,.22),0 0 8px rgba(248,113,113,.55)", flexShrink: 0 }} />
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: FR, fontSize: 10, fontWeight: 700, color: INK }}>2 students hired this week</div>
      ...
      <div style={{ ...gSub(13), padding: "10px 14px", display: "flex", alignItems: "center", gap: 10, borderLeft: `3px solid ${C.accent}` }}>
        ...
        <div>
          <div style={{ fontFamily: FR, fontSize: 10, fontWeight: 700, color: INK }}>&lt;2hr reply guaranteed</div>
  ...
  useEffect(() => {
    ...
    const showCallouts = (idx: number) => {
      CWs[idx]?.querySelectorAll<HTMLElement>("[data-callout]").forEach((el, i) => {
        ...
        gsap.to(el, { y: "+=9", ease: "sine.inOut", yoyo: true, repeat: -1, duration: 2.6 + i * .44, delay: .9 + i * .14 })
      })
    }
    const hideCallouts = (idx: number) => {
      CWs[idx]?.querySelectorAll<HTMLElement>("[data-callout]").forEach(el => {
        gsap.killTweensOf(el)
        gsap.to(el, { opacity: 0, y: -10, filter: "blur(4px)", duration: 0.2, ease: "power2.in", overwrite: "auto" })
      })
    }
    ...
    style={{ backgroundImage: `url("/images/BgImgs/SorftGlassy.png")`, backgroundSize: "cover",isolation: "isolate" }}>
      ...
      <div ref={pinWrapRef} className="hidden md:block relative w-full"
        ...
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "11%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px", zIndex: 5 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ fontFamily: FN, fontSize: 12.5, fontWeight: 900, color: INK }}>Prince Dev</div>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            <div style={{ ...gSub(20), padding: "5px 14px", display: "inline-flex", alignItems: "center", gap: 7 }}>
              ...
              <span style={{ fontFamily: FR, fontSize: 9, fontWeight: 600, color: INK }}>Open for projects</span>
            </div>
      ...
      <div className="md:hidden" style={{ background: "linear-gradient(160deg,#c4d6ec 0%,#d8e8f5 50%,#e4edf7 100%)", padding: "48px 16px 80px" }}>
          ...
          <div style={{ position: "relative", height: 300, marginBottom: 24, borderRadius: 24, overflow: "hidden", background: MODEL_CARD_GLASS, backdropFilter: `blur(${MODEL_CARD_BLUR})`, WebkitBackdropFilter: `blur(${MODEL_CARD_BLUR})`, border: `1px solid ${MODEL_CARD_BORDER}` }}>
            ...
            {CALLOUTS[0].slice(0, 4).map((c, i) => (
              <div key={i} style={{ position: "absolute", top: `${12 + i * 22}%`, left: i % 2 === 0 ? "4%" : "auto", right: i % 2 !== 0 ? "4%" : "auto", background: "rgba(255,255,255,0.18)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.40)", borderRadius: 11, padding: "5px 11px", boxShadow: "0 4px 16px rgba(60,80,200,.12)" }}>
                ...
                <span style={{ fontFamily: FN, fontSize: 14, fontWeight: 900, color: "#fff", lineHeight: 1, display: "block", textShadow: "0 1px 5px rgba(0,0,0,0.25)" }}>{c.v}</span>
              </div>
            ))}
          </div>
        </MC>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <MC><div style={{ fontFamily: FN, fontWeight: 900, fontSize: "clamp(2rem,8vw,3rem)", color: INK, lineHeight: 1.06, letterSpacing: "-.03em", marginBottom: 12 }}>Built by<br /><span style={{ color: C.accent }}>Prince.</span></div></MC>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <MC><div style={{ fontFamily: FN, fontWeight: 900, fontSize: "clamp(2rem,8vw,3rem)", color: INK, lineHeight: 1.06, letterSpacing: "-.03em", marginBottom: 14 }}>Real work,<br /><span style={{ color: C.accent }}>real results.</span></div></MC>
          <MC>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <MC><div style={{ fontFamily: FN, fontWeight: 900, fontSize: "clamp(2rem,8vw,3rem)", color: INK, lineHeight: 1.06, letterSpacing: "-.03em", marginBottom: 14 }}>Students<br /><span style={{ color: C.accent }}>come back.</span></div></MC>
          <MC>
            <LiquidGlassCard className="rounded-2xl border-white/60 bg-white/10 mb-3" glassSize="sm">
              <div style={{ fontFamily: FN, fontSize: 32, color: C.accent, opacity: .16, lineHeight: .6, marginBottom: 6 }}>&ldquo;</div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div><p style={{ fontFamily: FR, fontWeight: 700, fontSize: 11, color: INK }}>Aryan S. <span style={{ color: C.muted, fontWeight: 400 }}>· SPPU</span></p><Stars /></div>
              </div>
            </LiquidGlassCard>
          </MC>
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <MC><div style={{ fontFamily: FN, fontWeight: 900, fontSize: "clamp(2rem,8vw,3rem)", color: INK, lineHeight: 1.06, letterSpacing: "-.03em", marginBottom: 14 }}>Your deadline<br /><span style={{ color: C.accent }}>is my priority.</span></div></MC>
          <MC>
          ...
          <MC>
            <Button
              onClick={() => document.getElementById("req_a_project")?.scrollIntoView({ behavior: "smooth" })}
              className="w-full font-bold text-base gap-2 rounded-2xl py-6"
              style={{ fontFamily: FR, background: "linear-gradient(135deg,#4f46e5,#6366f1,#818cf8)", boxShadow: "0 4px 0 #3730a3,0 8px 28px rgba(99,102,241,.35)", border: "none" }}
            >
